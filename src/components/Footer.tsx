		...
		>
			...
			<div className="container pb-8 pt-16 sm:pt-24 lg:pt-32">
				<div className="xl:grid xl:grid-cols-3 xl:gap-8">
						...
						<div className="">
							<div>
								...
								<ul role="list" className="mt-6 space-y-4">
									...
									{/* open extra relevant articles */}
									<li>
										<button
											className="text-sm text-zinc-100/50 hover:text-zinc-100/70"
											onClick={() =>
										...
										>
											Meer artikelen
											<svg
												className="ml-2 inline h-3 w-3 object-contain"
												viewBox="0 -4.5 20 20"
												version="1.1"
												xmlns="http://www.w3.org/2000/svg"
											>
					...
					<div
						className="grid xl:col-span-3 xl:grid-cols-4"
						// slide in and out based on otherState's value, use inline style and not display: none
						style={{
							transition: 'all 0.5s ease-in-out',
							maxHeight: otherState ? '1000px' : '0px',
							overflow: 'hidden',
						}}
					>
						<ul role="list" className="mt-6 space-y-4">
							{navigation.extraRelevantArticles.map((item) => (
								<li key={item.name}>
									<Link
										href={item.href}
										className="text-sm leading-6 text-gray-300 hover:text-white"
				...
				<div className="mt-8 border-t border-white/10 pt-8 sm:mt-12 lg:mt-12">
